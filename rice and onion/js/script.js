...
const FALLBACK_DATA = {
    ...
    plots: [
        ...
        { plot_name: "Plot A3", crop_type: "Onion", status: "Available", variety_name: null },
        { plot_name: "Plot A4", crop_type: "Rice",  status: "Occupied", variety_name: "NSIC Rc222 Rice" },
        { plot_name: "Plot A5", crop_type: "Onion", status: "Occupied", variety_name: "Yellow Granex Onion" },
        { plot_name: "Plot A6", crop_type: "Rice",  status: "Available", variety_name: null }
    ],
    tasks: [
        { plot_name: "Plot A1", crop_type: "Onion", is_done: 0 },
        { plot_name: "Plot A2", crop_type: "Rice", is_done: 0 },
        { plot_name: "Plot A5", crop_type: "Onion", is_done: 1 }
    ],
    harvests: [

shell(
    'Dashboard',
    "Here's what's happening across the onion and rice plots today.",
    `<section id="dash"></section>`
);

async function load() {
    try {
        const d = await api('get_dashboard_data.php');

        document.getElementById('dash').innerHTML = `
            <div class="stats">
                <div class="stat">
                    <b>${d.stats.onion}</b>
                    <span>Onion Plots</span>
                </div>
            ...
            <section class="card">
                ...
                <p>
                    ...
                    <a href="plots.html">Plots page</a>.
                </p>
                ...
                <div class="plot-grid">
                    ${d.plots.map(p => `
                        <div class="plot-card">
                            ...
                            <small>${esc(p.crop_name || 'No current planting')}</small>
                            <div>
            ...
            <div class="two-col">
                ...
                <section class="card">
                    ...
                    ${d.tasks.length
                        ...
                        `).join('')
                        : '<div class="empty">No watering tasks due today.</div>'
                    }
                </section>
                ...
                <div class="stack">
                    ...
                    <section class="card">
                        ...
                        ${d.harvests.length
                            ...
                            `).join('')
                            : '<div class="empty">No harvest records.</div>'
                        }
                    </section>
                    ...
                    <section class="card">
                        ...
                        ${d.seeds.slice(0, 4).map(s => `
                            <div class="list-row">
                                <span>${esc(s.seed_name)}</span>
